...
public class MessageSender {
	...
	static final String CONCEPT_DRIFT_IP = "Enter IP";
	static final int CONCEPT_DRIFT_PORT = 8080;
	
	// Intelligent Recommendation Engine
	// IP -> MN
	static final String INTELLIGENT_ENGINE_IP = "Enter IP";
	static final int INTELLIGENT_ENGINE_PORT = 8080;
	
	// Intelligent Kalman Filtering
	// IP -> MN
	static final String INTELLIGENT_KALMAN_IP = "Enter IP";
	static final int INTELLIGENT_KALMAN_PORT = 8080;
		
	// Load Shedding Manager
	static final String LOAD_SHEDDIING_MANAGER_IP = "Enter IP";
	static final int LOAD_SHEDDIING_MANAGER_PORT = 8080;
